...
function LogIn() {
 const [isOpen, setIsOpen,HandSubmit] = LoginLogic()
  return (
        ...
        <div className="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
          <form className="space-y-6" onSubmit={HandSubmit} method="POST">
            ...
            <div>
              <button
                type="submit"
                className="flex w-full justify-center rounded-md  px-3 py-1.5 text-sm font-semibold leading-6  shadow-sm button focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 hover:scale-110 ease-in-out duration-300"
              >
                Sign in
              </button>
            </div>
