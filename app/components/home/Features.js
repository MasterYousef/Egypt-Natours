...
function Features() {
  return (
    <div className=' h-screen w-full my-40 relative flex justify-center items-center'>
      <div className='w-full bg-yellow-300 opacity-70 h-full absolute z-10 img-clip2' ></div>
        <Image src={im.src} width={1000} height={1000} className='w-full h-full img-clip2 absolute' />
