  ...
  return (
    <div className='md:py-20 lg:py-0'>
        ...
        <div className=' mt-10 lg:mt-16 flex flex-col  lg:flex-row'>
            ...
            <Image src={p1.src} width={1000} height={300} className='absolute z-20 lg:left-1/4 lg:top-8 lg:w-80 p h-full w-1/2 left-0 md:w-1/3 md:h-56 -top-1/4 md:left-12' />
            <Image src={p2.src} width={1000} height={300} className='absolute z-30 lg:top-24 lg:left-0 lg:w-80 p h-full w-1/2 left-1/4 md:w-1/3 md:h-56 -top-1/3 md:left-1/3'/>
            <Image src={p3.src} width={1000} height={400} className='absolute -top-1/4 z-10 p md:w-1/3 h-full w-1/2 right-0 md:h-56 md:right-12 lg:right-2/4 lg:w-80  lg:top-0'/>
            </div>
        </div>
    </div>
  )
